        ...
        <main>
            <div id="detalhe_produto">
                <ul>
                    ...
                    <li><b>Tempo entrega: </b><?php echo $tempoentrega ?></li>
                    <li><b>Preço unitario: R$ </b><?php echo number_format($precounitario, 2,",",".") ?></li>
                    <li><b>Preço revenda: R$ </b><?php echo number_format($precorevenda, 2,",",".") ?></li>
